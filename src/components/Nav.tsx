            ...
            <div className="wrapper rounded-2xl flex p-1 bg-white/10  justify-center">
                <div className="nav-left  flex justify-start items-center">
                    ...
                    <div className="nav-skill-search-box">
                        <input type="text" placeholder='Explore...' className="search-box transition-ui w-2 focus:w-auto border-1 border-white/10   outline-0 bg-white/5 focus:bg-white/15 rounded-2xl px-3 py-2" />
                    </div>
                </div>
